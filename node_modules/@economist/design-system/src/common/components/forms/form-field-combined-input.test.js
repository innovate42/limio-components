...
describe('<FormFieldCombinedInput />', () => {
  it('should pass default props to the FormInput component', () => {
    const component = shallow(
      <FormFieldCombinedInput buttonLabel='Button' labelText='Form label' />,
    );
  ...
  it('should pass props to the Button component', () => {
    ...
    expect(button.props().onClick).toEqual(handleOnClick);
    expect(button.props().type).toEqual('submit');
  });

  it('should render a SlimButton when slim prop is true', () => {
    const component = shallow(
      <FormFieldCombinedInput
        slim
        buttonLabel='Button'
    ...
    const slimButton = component.find('SlimButton');
    expect(slimButton.length).toEqual(1);
  });
