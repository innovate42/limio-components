...
const SocialIconInstagram = props => (
  <svg viewBox='-1 -1 34 34' width={32} height={32} {...props}>
    <title>Instagram</title>
    <defs>
      <path id='a' d='M0 .006h19.994v19.992H0z' />
    </defs>
    <g id='share-instagram' fill='none' fillRule='evenodd'>
      <circle
      ...
      <path
        className='path-foreground'
        d='M15.997 19.335a3.332 3.332 0 1 1 0-6.664 3.332 3.332 0 0 1 0 6.664zm0-8.465a5.133 5.133 0 1 0 0 10.267 5.133 5.133 0 0 0 0-10.267zM22.533 10.667a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0'
        fill='#FFF'
      />
    </g>
  </svg>
