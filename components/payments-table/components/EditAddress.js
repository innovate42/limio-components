...
export const EditAddress = ({setEditAddress, handleAddressFieldChange, handleSubmit, newAddress, formErrors, loading}) => {
    ...
    return(
        ...
        <form className=" bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white flex flex-col items-center px-8 py-10 w-3/4 h-96 overflow-y-auto  my-8 opacity-90"
