          ...
          <div className="flex mt-auto">
            {allow_multibuy__limio && (
             ...
             onClick={() => addToBasket(item, { quantity, redirectUrl: redirectUrl })}
                    className={`w-full mt-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ${allow_multibuy__limio ? "rounded-r-lg " : "rounded-lg"}`}
                    style={{ marginRight: "0" }} 
                    >
