...
export const ConfirmDialog = ({confirmHeading, offer, previewSchedule, nextSchedule, paymentMethodHeading, paymentMethod, loading, setLoading, setShowDialog, confirmationOk, confirmationCancel, onConfirm, redirectUrl }) => {
