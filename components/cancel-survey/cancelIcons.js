...
export const cancelIcons = (primary, secondary) => ({
  quantity: (
    <svg
  ...
  expensive: (
    ...
    >
      ...
      <path
        id="icon-secondary-color"
        fill={secondary}
        d="M280 350.44V368a16 16 0 0 1-16 16h-16a16 16 0 0 1-16-16v-17.73a73 73 0 0 1-31.78-11.46c-6.22-4.11-6.82-13.11-1.55-18.38l17.52-17.52c3.74-3.74 9.31-4.24 14.11-2a24.52 24.52 0 0 0 10.26 2.22h32.78a8.43 8.43 0 0 0 2.32-16.53l-50.07-14.3c-22.25-6.35-40-24.71-42.91-47.67a56.27 56.27 0 0 1 49.32-63V144a16 16 0 0 1 16-16h16a16 16 0 0 1 16 16v17.73a73 73 0 0 1 31.78 11.46c6.22 4.11 6.82 13.11 1.55 18.38l-17.52 17.52c-3.74 3.74-9.31 4.24-14.11 2a24.54 24.54 0 0 0-10.26-2.22h-32.78a8.43 8.43 0 0 0-2.32 16.53l50.07 14.3c22.25 6.36 40 24.71 42.91 47.67a56.27 56.27 0 0 1-49.32 63z"
      />
    </svg>
  ),
  dislike: (
    ...
    >
      <path
        id="icon-primary-color"
        fill={primary}
        d="M512 277.9c-.16 30.35-26.16 58.1-59.55 58.1H350.72C358 364.34 384 388.13 384 430.55 384 504 336 512 312 512c-20.18 0-29.48-39.29-33.93-57.79-5.21-21.67-10.59-44.07-25.39-58.91-32.47-32.52-49.51-74-89.12-113.11a12 12 0 0 1-3.56-8.52V59.9a12 12 0 0 1 11.78-12c15.83-.29 36.7-9.08 52.66-16.17C256.19 17.6 295.71 0 344 0h2.85c42.78 0 93.36.41 113.77 29.74 8.39 12.05 10.45 27 6.15 44.63 16.31 17 25.06 48.86 16.38 74.76 17.55 23.43 19.15 56.13 9.31 79.46l.11.12C504.45 240.65 512.08 260 512 277.9z"
      />
      <path
        id="icon-secondary-color"
        fill={secondary}
        d="M104 32H24A24 24 0 0 0 0 56v240a24 24 0 0 0 24 24h80a24 24 0 0 0 24-24V56a24 24 0 0 0-24-24zM64 280a24 24 0 1 1 24-24 24 24 0 0 1-24 24z"
      />
    </svg>
  ),
  alternative: (
  ...
  other: (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color" fill={primary} d="M256 184a72 72 0 1 0 72 72 72 72 0 0 0-72-72z" />
      <path id="icon-secondary-color" fill={secondary} d="M432 184a72 72 0 1 0 72 72 72 72 0 0 0-72-72zm-352 0a72 72 0 1 0 72 72 72 72 0 0 0-72-72z" />
    </svg>
  ),
  pause: (
    <svg
  ...
  computer: (
    <svg
      ...
      focusable="false"
      data-prefix="fad"
      data-icon="laptop-medical"
      className="svg-inline--fa fa-cc-visa fa-w-18"
      role="img"
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color" fill={primary} d="'M528 0H112a48.14 48.14 0 0 0-48 48v336h512V48a48.14 48.14 0 0 0-48-48zm-16 320H128V64h384z" />
      <path
        id="icon-secondary-color"
        fill={secondary}
  ...
  skip: (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color" fill={primary} d="M224 297.69L52.5 440.61C31.9 457.81 0 443.41 0 416V96c0-27.4 31.9-41.7 52.5-24.6L224 214.32z" />
      <path
        id="icon-secondary-color"
        fill={secondary}
  ...
  discount: (
    ...
    >
      ...
      <path
        id="icon-secondary-color"
        fill={secondary}
        d="M192 160a32 32 0 1 1-32 32 32 32 0 0 1 32-32zm12.28 181.65a16 16 0 0 1-22.63 0l-11.31-11.31a16 16 0 0 1 0-22.63l137.37-137.37a16 16 0 0 1 22.63 0l11.31 11.31a16 16 0 0 1 0 22.63zM320 352a32 32 0 1 1 32-32 32 32 0 0 1-32 32z"
      />
    </svg>
  ),
  mail: (
...
export const helpIcons = (primary, secondary) => ({
  skip: (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
