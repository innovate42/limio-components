...
export const cancelIcons = () => ({
  ...
  other: (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color"  fill="#FFFFFF" d="M256 184a72 72 0 1 0 72 72 72 72 0 0 0-72-72z" />
      <path id="icon-secondary-color"  fill="#FFFFFF" d="M432 184a72 72 0 1 0 72 72 72 72 0 0 0-72-72zm-352 0a72 72 0 1 0 72 72 72 72 0 0 0-72-72z" />
    </svg>
  ),
  pause: (
    <svg
  ...
  computer: (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color"  fill="#FFFFFF" d="'M528 0H112a48.14 48.14 0 0 0-48 48v336h512V48a48.14 48.14 0 0 0-48-48zm-16 320H128V64h384z" />
      <path
        id="icon-secondary-color"
        fill="#FFFFFF"
  ...
  skip: (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path id="icon-primary-color"  fill="#FFFFFF" d="M224 297.69L52.5 440.61C31.9 457.81 0 443.41 0 416V96c0-27.4 31.9-41.7 52.5-24.6L224 214.32z" />
      <path
        id="icon-secondary-color"
        fill="#FFFFFF"
