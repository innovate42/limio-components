...
<div className="sb-container">
  <div className="sb-image-container">
    <img src={"https://user-images.githubusercontent.com/11695131/212103845-0912408e-51bb-4f19-8ea4-6ce98a18e54e.png"} alt="Limio" />
  </div>
  ...
  <div className='sb-section-title'>
    ...
    Limio components are React components. Anything that you can package up into a React component can be used in Limio.
    ...
    * Use limioProps in your package.json to make your component customisable.
    ...
    <div className="sb-image-container lg">
      <img src={"https://user-images.githubusercontent.com/11695131/212106500-45dfdfe5-fb0b-4e48-b264-ca0d7a7f362b.png"} alt="Limio" />
    </div>
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">String</h4>
        <p className="sb-section-item-paragraph">
          This prop type will show a plaintext string field.
      ...
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">Rich Text</h4>
        <p className="sb-section-item-paragraph">
          This prop type will show a rich text editor.
      ...
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">Boolean</h4>
        <p className="sb-section-item-paragraph">
      ...
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">Colour</h4>
        <p className="sb-section-item-paragraph">
      ...
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">Date Time</h4>
        <p className="sb-section-item-paragraph">
      ...
      <div className="sb-grid-item">
        <h4 className="sb-section-item-heading">Picklist</h4>
        <p className="sb-section-item-paragraph">
        This prop type will show a picklist of the options with **one** being selectable.
...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Limio Shop (Acquisition)</h4>
      <p className="sb-section-item-paragraph">
    ...
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Limio Self-Service (My Account)</h4>
      <p className="sb-section-item-paragraph">
    ...
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Visual</h4>
      <p className="sb-section-item-paragraph">
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Header/Footer</h4>
      <p className="sb-section-item-paragraph">
    ...
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Enforcement / Eligibility</h4>
      <p className="sb-section-item-paragraph">
    ...
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Interactive</h4>
      <p className="sb-section-item-paragraph">
